...
export const FloatingActionButtons = () => {
    return (
        <div className="fixed right-6 bottom-24 z-50 flex flex-col gap-4 items-center">
            ...
            {/* Proposal Button */}
            <motion.div
                onClick={() => window.open('https://mongstarz-intro.vercel.app', 'Proposal', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1024,height=768')}
