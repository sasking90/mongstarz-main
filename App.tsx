...
const revenueData = [
    ...
    { step: 'Step 2', label: 'Special Issue', desc: '참가권 사용 및 아이템 획득', icon: Ticket, color: 'text-violet-500', bg: 'bg-violet-50' },
    { step: 'Step 3', label: 'Prize Draw', desc: '현물 경품 응모', icon: Gift, color: 'text-fuchsia-500', bg: 'bg-fuchsia-50' },
...
const adProducts = [
    {
        ...
        desc: "참가권을 사용하여 광고를 진입 시 미니게임을 즐기며 '타임(Time)' 재원을 대가로 획득하는 콘텐츠입니다. 짧은 시간 내 집중적인 사용자 참여를 유도하여 높은 트래픽과 높은 클릭률(CTR)을 보장합니다.",
    ...
    },
    {
        ...
        title: "Time Attack",
        subTitle: "Prize Game",
        desc: "획득한 '타임'을 소모하여 제한 시간 내에 고가 경품 획득에 도전하는 긴박감 넘치는 게임입니다. 지속적인 시도와 도전을 자극하여 사용자의 앱 체류 시간을 극대화하고 반복적인 광고 노출 효과를 창출합니다.",
    ...
    },
    {
        ...
        desc: "사용자가 브랜드 관련 퀴즈를 풀고 보상을 받는 학습형 광고입니다. 단순 노출을 넘어 브랜드의 핵심 메시지를 자연스럽게 각인시키며, 높은 정답률을 통해 확실한 인지 상승 효과를 제공합니다.",
    ...
    },
    {
        ...
        desc: "참가권을 사용하여 알파벳 카드를 수집하고, 짝을 맞추면 즉시 경품을 획득하는 직관적인 매칭 게임입니다. '즉각적인 보상' 심리를 자극하여 가벼운 마음으로 광고에 접속하게 만들고 높은 참여율을 이끌어냅니다.",
    ...
    },
    {
        ...
        desc: "참가권으로 응모번호를 발급받고, 공식 SNS 라이브 방송에서 당첨을 확인하는 소셜형 이벤트입니다. 참여 조건으로 '구독'과 '좋아요'를 유도하여 브랜드 채널을 성장시키고, 자발적인 바이럴 마케팅 효과를 극대화합니다.",
    ...
    },
    {
        ...
        desc: "참가권을 소모하여 명품 가방, 시계 등 하이엔드 경품 획득에 도전하는 프리미엄 전용관(명품관)입니다. 참여 과정에서 고단가 타겟 광고(CPC/CPA)를 자연스럽게 노출하여, 사용자에게는 '대박의 기회'를, 광고주에게는 '고수익 모델'을 동시에 제공합니다.",
        tags: ['High Value', 'Ad Revenue', 'Premium'],
        effect: "타겟 광고 수익(CPC) 200% 증대, 고가치 유저 확보",
    ...
    },
    {
        ...
        desc: "이용권을 사용하여 식음료, 뷰티, 클래스 등 오프라인 매장의 실물 체험권을 획득하는 O2O 특화 체험관입니다. 온라인 사용자의 발길을 실제 오프라인 매장으로 이끄는 'Drive-to-Store' 효과를 통해 광고주에게 확실한 신규 고객 유입을 보장합니다.",
        tags: ['Drive to Store', 'Voucher', 'Local Ad'],
        effect: "오프라인 매장 방문율 40% 증가, 신규 고객 유입 증대",
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8 lg:mt-10">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex-1 sm:w-48 px-5 py-4 rounded-[1.125rem] font-extrabold text-sm lg:text-lg transition-all duration-500 flex items-center justify-center gap-2 lg:gap-3 group hover:-translate-y-2 hover:scale-105 active:scale-100 active:translate-y-0 shadow-[0_4px_16px_rgba(99,102,241,0.25),0_8px_32px_rgba(99,102,241,0.15),inset_0_1px_0_rgba(255,255,255,0.15)] hover:shadow-[0_8px_24px_rgba(99,102,241,0.4),0_16px_48px_rgba(99,102,241,0.25),inset_0_1px_0_rgba(255,255,255,0.25)] bg-gradient-to-br from-indigo-500 via-violet-500 to-violet-600 text-white border border-indigo-400/60 hover:border-indigo-300/70 relative overflow-hidden"
                                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        ...
                        <h2 className="text-3xl lg:text-5xl font-black mt-6 mb-6 text-slate-900 leading-[1.1] tracking-[-0.01em]">
                            '보상'과 '참여'로 진화하는<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-fuchsia-500 to-orange-500">차세대 광고 시장</span>의 미래
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-16">
                        <div className="p-10 lg:p-12 bg-gradient-to-br from-white via-white to-violet-50/20 rounded-[2.5rem] border border-violet-100/60 hover:border-violet-300/60 transition-all duration-700 shadow-[0_2px_8px_0_rgba(0,0,0,0.04),0_8px_24px_-4px_rgba(139,92,246,0.08),0_16px_48px_-8px_rgba(139,92,246,0.12)] hover:shadow-[0_4px_12px_0_rgba(139,92,246,0.1),0_12px_32px_-4px_rgba(139,92,246,0.2),0_24px_64px_-8px_rgba(139,92,246,0.3)] hover:-translate-y-4 hover:scale-[1.02] group backdrop-blur-sm">
                            ...
                            <p className="text-sm text-slate-600 font-bold">국내 리워드 앱 사용자 수 (2024)</p>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-500 text-center mb-10 font-medium text-sm lg:text-base">지속적으로 성장하고 확장하는 리워드 광고 시장</p>
