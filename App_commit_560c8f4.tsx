...
const marketData = [
  { year: '2021', size: 8, label: '8議?, growth: 12 },
  { year: '2022', size: 8.4, label: '8.4議?, growth: 5 },
  { year: '2023', size: 8.7, label: '8.7議?, growth: 4 },
  { year: '2025', size: 9.2, label: '9.2議?, growth: 6 },
];

const revenueData = [
  { step: 'Step 1', label: 'User Action', desc: '愿묎퀬 李몄뿬 & 誘몄뀡 ?섑뻾', icon: MousePointerClick, color: 'text-blue-500', bg: 'bg-blue-50' },
  { step: 'Step 2', label: 'Ticket Issue', desc: '?묐え沅?Ticket) ?띾뱷', icon: Ticket, color: 'text-violet-500', bg: 'bg-violet-50' },
  { step: 'Step 3', label: 'Prize Draw', desc: '?ㅻЪ 寃쏀뭹 ?묐え', icon: Gift, color: 'text-fuchsia-500', bg: 'bg-fuchsia-50' },
  { step: 'Step 4', label: 'Ad Revenue', desc: '愿묎퀬二?吏묓뻾鍮??섏씡??, icon: Coins, color: 'text-amber-500', bg: 'bg-amber-50' },
];
...
const adProducts = [
  {
    ...
    desc: "李멸?沅뚯쓣 ?ъ슜?섏뿬 愿묎퀬??吏꾩엯 ?? 誘몃땲寃뚯엫??利먭린硫?'???Time)' ?먯썝????됱쑝濡??띾뱷?섎뒗 而⑦뀗痢좎엯?덈떎. 吏㏃? ?쒓컙 ??吏묒쨷?곸씤 ?ъ슜??李몄뿬瑜??좊룄?섏뿬 ??컻?곸씤 ?몃옒?쎄낵 ?믪? ?대┃瑜?CTR)??蹂댁옣?⑸땲??",
    tags: ['Mass Traffic', 'Earning', 'High CTR'],
    effect: "1?쒓컙 ???됯퇏 李몄뿬??5留?紐? ?대┃瑜?15% ?댁긽 ?ъ꽦",
  ...
  },
  {
    ...
    title: "Time Attack",
    subTitle: "Prize Game",
    desc: "?띾뱷??'??????뚮え?섏뿬 ?쒗븳 ?쒓컙 ?댁뿉 怨좉? 寃쏀뭹 ?띾뱷???꾩쟾?섎뒗 湲대컯媛??섏튂??寃뚯엫?낅땲?? 吏?띿쟻???щ룄?꾩쓣 ?먭레?섏뿬 ?ъ슜?먯쓽 ??泥대쪟 ?쒓컙??洹밸??뷀븯怨?諛섎났?곸씤 愿묎퀬 ?몄텧 ?④낵瑜?李쎌텧?⑸땲??",
    tags: ['Retention', 'Play', 'Viral'],
    effect: "?됯퇏 泥대쪟 ?쒓컙 15遺??댁긽, ?ъ젒?띾쪧 40% 利앷?",
  ...
  },
  {
    ...
    desc: "?ъ슜?먭? 釉뚮옖??愿???댁쫰瑜??怨?蹂댁긽??諛쏅뒗 ?숈뒿??愿묎퀬?낅땲?? ?⑥닚 ?몄텧???섏뼱 釉뚮옖?쒖쓽 ?듭떖 硫붿떆吏瑜??먯뿰?ㅻ읇寃?媛곸씤?쒗궎硫? ?믪? ?뺣떟瑜좎쓣 ?듯빐 ?뺤떎???몄????곸듅 ?④낵瑜??쒓났?⑸땲??",
    tags: ['Education', 'Awareness', 'Fun'],
    effect: "釉뚮옖???ㅼ썙??寃?됰웾 300% 利앷?, ?뺣떟瑜?90% ?댁긽",
  ...
  },
  {
    ...
    desc: "李멸?沅뚯쓣 ?ъ슜???뚰뙆踰?移대뱶瑜??ㅼ쭛怨? 吏앹쓣 留욎텛硫?利됱떆 寃쏀뭹???띾뱷?섎뒗 吏곴??곸씤 留ㅼ묶 寃뚯엫?낅땲?? '利됯컖?곸씤 蹂댁긽' ?щ━瑜??먭레?섏뿬 媛踰쇱슫 留덉쓬?쇰줈 愿묎퀬???묒냽?섍쾶 留뚮뱾怨??믪? 李몄뿬?⑥쓣 ?대걣?대깄?덈떎.",
    tags: ['Instant Win', 'Matching', 'O2O'],
    effect: "留ㅼ옣 諛⑸Ц ?꾪솚??12%, 荑좏룿 ?ъ슜瑜?25% 湲곕줉",
  ...
  },
  {
    ...
    desc: "李멸?沅뚯쑝濡??묐え踰덊샇瑜?諛쒓툒諛쏄퀬, 怨듭떇 SNS ?쇱씠釉?諛⑹넚?먯꽌 ?뱀꺼???뺤씤?섎뒗 ?щ뜡???대깽?몄엯?덈떎. 李몄뿬 議곌굔?쇰줈 '援щ룆'怨?'醫뗭븘??瑜??좊룄?섏뿬 釉뚮옖??梨꾨꼸???щ뜡???뺤옣?섍퀬, ?먮컻?곸씤 諛붿씠??留덉????④낵瑜?洹밸??뷀빀?덈떎.",
    tags: ['SNS Growth', 'Live Event', 'Fandom'],
    effect: "SNS 援щ룆??300% 利앷?, 寃뚯떆臾??꾨떖瑜?5諛??곸듅",
  ...
  },
  {
    ...
    desc: "李멸?沅뚯쓣 ?뚮え?섏뿬 紐낇뭹 媛諛? ?쒓퀎 ???섏씠?붾뱶 寃쏀뭹 ?띾뱷???꾩쟾?섎뒗 ?꾨━誘몄뾼 ?꾩슜愿(紐낇뭹愿)?낅땲?? 李몄뿬 怨쇱젙?먯꽌 怨좊떒媛 ?몃? 愿묎퀬(CPC/CPA)瑜??먯뿰?ㅻ읇寃??몄텧?섏뿬, ?ъ슜?먯뿉寃뚮뒗 '?諛뺤쓽 湲고쉶'瑜? ?뚮옯?쇱뿉??'怨좎닔??紐⑤뜽'???숈떆???쒓났?⑸땲??",
    tags: ['High Value', 'Ad Revenue', 'Premium'],
    effect: "?몃? 愿묎퀬 ?섏씡(CPC) 200% 利앸?, 怨좉????좎? ?뺣낫",
  ...
  },
  {
    ...
    desc: "李멸?沅뚯쓣 ?ъ슜?섏뿬 ?앹쓬猷? 酉고떚, ?대옒?????ㅽ봽?쇱씤 留ㅼ옣???ㅻЪ 泥댄뿕沅뚯쓣 ?띾뱷?섎뒗 O2O ?뱁솕 泥댄뿕愿?낅땲?? ?⑤씪???ъ슜?먯쓽 諛쒓만???ㅼ젣 ?ㅽ봽?쇱씤 留ㅼ옣?쇰줈 ?대걚??'Drive-to-Store' ?④낵瑜??듯빐 愿묎퀬二쇱뿉寃??뺤떎???좉퇋 怨좉컼 ?좎엯??蹂댁옣?⑸땲??",
    tags: ['Drive to Store', 'Voucher', 'Local Ad'],
    effect: "?ㅽ봽?쇱씤 留ㅼ옣 諛⑸Ц??40% 利앷?, ?좉퇋 怨좉컼 ?좎엯 ?뺣?",
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg lg:text-2xl text-slate-200 mb-12 lg:mb-16 max-w-2xl leading-relaxed font-medium pl-6 lg:pl-8 border-l-4 border-teal-400/60 drop-shadow-lg">
                <strong>MONGSTARZ</strong>??寃뚯씠誘명뵾耳?댁뀡(Gamification)怨?吏??湲곕컲(Local) ?쒗깮??寃고빀?섏뿬,
                ?뚮퉬?먯뿉寃뚮뒗 <span className="text-white font-bold text-shadow-sm">?뺤떎??蹂댁긽</span>??
                ?뚰듃?덉뿉寃뚮뒗 <span className="text-white font-bold text-shadow-sm">?ㅺ뎄留??꾪솚</span>???쒓났?섎뒗 ?곸떊?곸씤 愿묎퀬 ?뚮옯?쇱엯?덈떎.
              </p>
              ...
              <div className="mt-14 lg:mt-20 grid grid-cols-3 gap-4 lg:gap-8 border-t border-white/10 pt-8 lg:pt-10 text-white">
                <div className="group cursor-default">
                  ...
                  <div className="text-[10px] lg:text-sm text-slate-300 font-bold uppercase tracking-wide">Ad Engagement<br />(愿묎퀬 紐곗엯??</div>
                </div>
                <div className="group cursor-default">
                  ...
                  <div className="text-[10px] lg:text-sm text-slate-300 font-bold uppercase tracking-wide">Higher ROAS<br />(愿묎퀬 ?⑥쑉)</div>
                </div>
                <div className="group cursor-default">
                  ...
                  <div className="text-[10px] lg:text-sm text-slate-300 font-bold uppercase tracking-wide">BM Patent<br />(?뱁뿀 ?깅줉)</div>
                </div>
              </div>
            </motion.div>
                    ...
                    <div className="px-4 lg:px-5 py-3 lg:py-4">
                      <div className="bg-white rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-7 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.03)] border border-slate-100">
                        <div className="grid grid-cols-4 gap-x-2 lg:gap-x-3 gap-y-5 lg:gap-y-6">
                          <AppIcon icon={Target} label="????? color="text-amber-600" bg="bg-amber-50" border="border-amber-100" />
                          <AppIcon icon={Timer} label="????댄깮" color="text-rose-600" bg="bg-rose-50" border="border-rose-100" />
                          <AppIcon icon={Trophy} label="????? color="text-violet-600" bg="bg-violet-50" border="border-violet-100" />
                          <AppIcon icon={HelpCircle} label="?댁쫰 ??? color="text-cyan-600" bg="bg-cyan-50" border="border-cyan-100" />

                          <AppIcon icon={MapPin} label="?뚰뙆 留ㅼ묶" />
                          <AppIcon icon={Gift} label="?붾툝 ?대깽?? />
                          <AppIcon icon={Gem} label="紐낇뭹愿" />
                          <AppIcon icon={Store} label="泥댄뿕愿" />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex gap-3 lg:gap-4 overflow-x-auto pr-6 pb-2 no-scrollbar snap-x">
                        {[1, 2, 3, 4].map((_, i) => (
                          <div key={i} className="flex-shrink-0 w-44 lg:w-48 bg-white rounded-2xl p-3 lg:p-4 border border-slate-100 shadow-[0_4px_12px_rgba(0,0,0,0.03)] flex items-center gap-3 snap-start hover:-translate-y-1 transition-transform cursor-pointer">
                            ...
                            <div className="flex flex-col">
                              <span className="text-[10px] text-slate-500 font-medium tracking-tight">user***??/span>
                              <span className="text-xs font-bold text-violet-600">移섑궓?명듃 ?뱀꺼!</span>
                            </div>
                          </div>
                        ))}
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            ...
            <h2 className="text-4xl lg:text-6xl font-black mt-8 mb-8 lg:mb-10 text-slate-900 leading-[1.1] tracking-[-0.01em]">
              '蹂댁긽'??怨?'留덉??????섎뒗<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-fuchsia-500 to-orange-500">李⑥꽭? 愿묎퀬 ?쒖옣</span>???꾨옒
            </h2>
            <p className="text-slate-600 text-lg lg:text-xl break-keep font-medium leading-relaxed">
              ?꾪넻?곸씤 ?붿뒪?뚮젅??愿묎퀬(DA)???⑥쑉 ??섎줈 ?명빐,<br className="hidden md:block" /> ?ъ슜?먭? ?λ룞?곸쑝濡?李몄뿬?섍퀬 蹂댁긽???띾뱷?섎뒗 <strong>Reward-based Ad Tech</strong>媛 ?좎씪????덉쑝濡??좎삤瑜닿퀬 ?덉뒿?덈떎.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-16">
            <div className="p-10 lg:p-12 bg-gradient-to-br from-white via-white to-violet-50/20 rounded-[2.5rem] border border-violet-100/60 hover:border-violet-300/60 transition-all duration-700 shadow-[0_2px_8px_0_rgba(0,0,0,0.04),0_8px_24px_-4px_rgba(139,92,246,0.08),0_16px_48px_-8px_rgba(139,92,246,0.12)] hover:shadow-[0_4px_12px_0_rgba(139,92,246,0.1),0_12px_32px_-4px_rgba(139,92,246,0.2),0_24px_64px_-8px_rgba(139,92,246,0.3)] hover:-translate-y-4 hover:scale-[1.02] group backdrop-blur-sm">
              ...
              <div className="text-5xl lg:text-6xl font-black text-slate-900 mb-5 tracking-[-0.02em] leading-none">1,022<span className="text-2xl lg:text-3xl text-slate-400 font-bold ml-2" style={{ fontFeatureSettings: '"tnum"' }}>留?/span></div>
              ...
              <p className="text-sm text-slate-600 font-bold">援?궡 由ъ썙?????ㅼ궗?⑹옄 ??(2024)</p>
            </div>
            ...
            <div className="p-10 lg:p-12 bg-gradient-to-br from-white via-white to-fuchsia-50/20 rounded-[2.5rem] border border-fuchsia-100/60 hover:border-fuchsia-300/60 transition-all duration-700 shadow-[0_2px_8px_0_rgba(0,0,0,0.04),0_8px_24px_-4px_rgba(232,121,249,0.08),0_16px_48px_-8px_rgba(232,121,249,0.12)] hover:shadow-[0_4px_12px_0_rgba(232,121,249,0.1),0_12px_32px_-4px_rgba(232,121,249,0.2),0_24px_64px_-8px_rgba(232,121,249,0.3)] hover:-translate-y-4 hover:scale-[1.02] group backdrop-blur-sm">
              ...
              <p className="text-sm text-slate-600 font-bold">?고룊洹??쒖옣 ?깆옣瑜?(2021-2025)</p>
            </div>
            ...
            <div className="p-10 lg:p-12 bg-gradient-to-br from-white via-white to-amber-50/20 rounded-[2.5rem] border border-amber-100/60 hover:border-amber-300/60 transition-all duration-700 shadow-[0_2px_8px_0_rgba(0,0,0,0.04),0_8px_24px_-4px_rgba(251,191,36,0.08),0_16px_48px_-8px_rgba(251,191,36,0.12)] hover:shadow-[0_4px_12px_0_rgba(251,191,36,0.1),0_12px_32px_-4px_rgba(251,191,36,0.2),0_24px_64px_-8px_rgba(251,191,36,0.3)] hover:-translate-y-4 hover:scale-[1.02] group backdrop-blur-sm">
              ...
              <div className="text-5xl lg:text-6xl font-black text-slate-900 mb-5 tracking-[-0.02em] leading-none">9.2<span className="text-2xl lg:text-3xl text-slate-400 font-bold ml-2" style={{ fontFeatureSettings: '"tnum"' }}>議?/span></div>
              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden my-5">
                <div className="h-full bg-amber-500 w-[90%] rounded-full"></div>
              </div>
              <p className="text-sm text-slate-600 font-bold">2025???덉긽 ?꾩껜 ?쒖옣 洹쒕え</p>
            </div>
          </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart key={graphKey} data={marketData} margin={{ top: 30, right: 30, left: 20, bottom: 20 }}>
                  ...
                  <Tooltip
                    ...
                    formatter={(value: any) => [`${value}議???, '?쒖옣 洹쒕え']}
                  />
                  <Bar
                    dataKey="size"
                    radius={[16, 16, 0, 0]}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <h2 className="text-3xl lg:text-5xl font-black mt-6 mb-6 text-slate-900">
              紐곗엯???믪?<br className="lg:hidden" /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-fuchsia-500">愿묎퀬 ?곹뭹 ?쇱씤??/span>
            </h2>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
            <FeatureCard
              delay={0.1}
              icon={Target}
              title="Hyper-Local ?寃잜똿"
              sub="Precision"
              highlight="Hit!"
              description="諛섍꼍 500m ?대궡 ?ъ슜?먮? ?뺣? ?寃잜똿?섏뿬 ??퉬 ?녿뒗 愿묎퀬 吏묓뻾??媛?ν빀?덈떎. 吏???뚯긽怨듭씤遺???湲곗뾽 ?꾨옖李⑥씠利덇퉴吏 理쒖쟻?붾맂 ?⑥쑉???쒓났?⑸땲??"
            />
            <FeatureCard
              delay={0.2}
              icon={Gamepad2}
              title="紐곗엯??寃뚯씠誘명뵾耳?댁뀡"
              sub="Fun Factor"
              highlight="Play"
              description="?⑥닚 ?몄텧???섏뼱, 寃뚯엫/?댁쫰/誘몄뀡???듯빐 ?ъ슜?먭? ?먮컻?곸쑝濡?愿묎퀬??李몄뿬?섍쾶 留뚮벊?덈떎. 愿묎퀬瑜?肄섑뀗痢좊줈 ?뚮퉬?섎뒗 ?덈줈??寃쏀뿕???좎궗?⑸땲??"
            />
            <FeatureCard
              delay={0.3}
              icon={TrendingUp}
              ...
              sub="Analytics"
              highlight="Grow"
              description="?대┃, 泥대쪟, 援щℓ ?꾪솚 ???ъ슜???됰룞 ?곗씠?곕? ?ㅼ떆媛꾩쑝濡?遺꾩꽍?섏뿬 愿묎퀬二쇱뿉寃??щ챸??由ы룷?몄? ?몄궗?댄듃瑜??쒓났?⑸땲??"
            />
          </div>
        </div>
      </section >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <p className="text-slate-700 text-lg leading-relaxed mb-10 font-medium break-keep max-w-3xl mx-auto">
              ?ъ슜?먮뒗 愿묎퀬 ?뚮퉬瑜??듯빐 '?묐え沅?Ticket)'???산퀬, ?대? ?듯빐 怨좉???寃쏀뭹???꾩쟾?⑸땲??<br className="hidden md:block" />
              ??怨쇱젙?먯꽌 諛쒖깮?섎뒗 ?몃옒?쎄낵 ?꾪솚??愿묎퀬 ?섏씡?쇰줈 吏곴껐?섎ŉ, 蹂댁긽 ?ъ썝?쇰줈 ?ы닾?먮맗?덈떎.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-slate-600 text-lg mb-10 leading-relaxed font-medium">
              MONGSTARZ? ?④퍡 ?덈줈??紐⑤컮??愿묎퀬 ?쒖옣???좊룄??br />
              ?뚰듃???щ윭遺꾩쓣 湲곕떎由쎈땲??
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center">
              <div className="flex-1 bg-slate-50 p-6 rounded-2xl border border-slate-100 hover:border-violet-200 transition-colors">
                ...
                <div className="text-xl font-bold text-slate-800">?대떦??/div>
            ...
            <div className="mt-12 pt-8 border-t border-slate-100 flex justify-center">
              <div className="flex items-center gap-2 opacity-50">
                ...
                <span className="text-slate-300">짤 2024 All Rights Reserved.</span>
              </div>
            </div>
          </motion.div>
        </div>
